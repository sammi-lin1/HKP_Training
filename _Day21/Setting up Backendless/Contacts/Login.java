    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(etMail.getText().toString().trim().isEmpty() || etPassword.getText().toString().isEmpty()) {
            ...
            public void handleResponse(Boolean response) {
                if(response) {
                   ...
                   tvLoad.setText("Logging you in...");
                    Backendless.Data.of(Backendless.class).findById(userObjectId, new AsyncCallback<Backendless>() {
                        @Override
                        public void handleResponse(Backendless response) {
                            ApplicationClass.user = response;
                            startActivity(new Intent(Login.this, MainActivity.class));
                            Login.this.finish();
                        }
