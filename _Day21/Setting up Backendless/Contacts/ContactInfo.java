...
import com.example.contacts.ui.main.ContactInfoFragment;
...
public class ContactInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            ivMail = findViewById(R.id.ivCall);
            ivEdit = findViewById(R.id.ivCall);
            ivDelete = findViewById(R.id.ivCall);
                    ...
                    if(etName.getText().toString().isEmpty() || etName.getText().toString().isEmpty() ||
                        ...
                        Backendless.Persistence.save(ApplicationClass.contacts.get(index), new AsyncCallback<Contact>() {
                            ...
                            public void handleResponse(Contact response) {
                                tvChar.setText(ApplicationClass.contacts.get(index).getName().toUpperCase().charAt(0)+"");
                                tvChar.setText(ApplicationClass.contacts.get(index).getName());
